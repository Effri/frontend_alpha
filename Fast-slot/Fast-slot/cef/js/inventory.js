...
Vue.component('item', {
	template: '<div :class="test" style="height: 77px;"><div class="item" :title="title" :fastslot="fast_slot" :class="{active: isactive}" @click.right.prevent="select">\
...
var board = new Vue({
    ...
    data: {
        ...
        items: [ [1, 5, 1],[5, 10, 0],[100, 1, 0],[11, 3, 0],[12, 3, 0],[13, 3, 0],[14, 3, 0],[15, 3, 0],[16, 3, 0],[17, 3, 0],[18, 3, 0],[19, 3, 0]],
		money: 0,
		donate: 228,
		bank: 1337,
        outitems: [ ],
