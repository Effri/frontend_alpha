var HUD = new Vue({
    ...
    methods: {
        ...
        showBonus() {
            ...
            if (this.bonusblock == true) {
                document.getElementById('bonus').classList.add('bonus-active');
                document.getElementById('bonus-block').classList.add('bonus-block-active');
            } else {
                document.getElementById('bonus').classList.remove('bonus-active');
                document.getElementById('bonus-block').classList.remove('bonus-block-active');
            }
        },
        showHelp() {
            this.helpBlock = !this.helpBlock;
            if (this.helpBlock == true) {
